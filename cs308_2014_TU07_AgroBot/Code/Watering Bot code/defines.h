...
/**********defines******************/
//The following pins are used to control the water flow from the motor

#define MOTOR_IO_0 (1<<2)	  //Pin 2 in PINSEL1 is used to set P0.17 as GPIO 
#define MOTOR_IO_1 (1<<3)	  //Pin 3 in PINSEL1 is used to set P0.17 as GPIO 
#define MOTOR  (1<<17)		  //Motor connected to P0.17 
/***********************************/
