...
### BEGIN INIT INFO
# Provides:		cameramon-service
# Required-Start:	$remote_fs $syslog
# Required-Stop:	$remote_fs $syslog
# Default-Start:	2 3 4 5
# Default-Stop:		0 1 6
# Short Description:	Captures snapshots from /dev/video0
# Long Description:	Captures snapshots from /dev/video0
### END INIT INFO

DIR=/opt/cameramon
DAEMON=$DIR/cameramon-svc.sh
DAEMON_NAME=cameramon-service
DAEMON_USER=root
